...
type
  TfrmPositionEdit = class(T_frmBasisDialog)
    qryList: TFDQuery;
    dsList: TDataSource;
    GDRES: TcxGrid;
    ...
    qryResPOSITIONRES_ID: TFDAutoIncField;
    qryResPOSITION_ID: TIntegerField;
    qryResLANGUAGE_ID: TIntegerField;
    qryResPOSITIONX: TWideStringField;
    qryResLANGUAGE: TStringField;
    TVRESPOSITIONRES_ID: TcxGridDBColumn;
    TVRESPOSITION_ID: TcxGridDBColumn;
    TVRESLANGUAGE_ID: TcxGridDBColumn;
    TVRESLANGUAGE: TcxGridDBColumn;
    TVRESPOSITIONX: TcxGridDBColumn;
...
var
  frmPositionEdit: TfrmPositionEdit;
...
constructor TfrmPositionEdit.SetStart(AOwner: TComponent; ID: Integer; WinMode: TWinMode);
begin
...
procedure TfrmPositionEdit.btnAddResClick(Sender: TObject);
begin
  inherited;
  FDS.Prepare;
  FDS.Params[0].AsString := 'CON_POSITIONRES';
...
procedure TfrmPositionEdit.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
  inherited;
...
procedure TfrmPositionEdit.FormCreate(Sender: TObject);
...
procedure TfrmPositionEdit.qryCheckLangResBeforeOpen(DataSet: TDataSet);
begin
  inherited;
  qryCheckLangRes.ParamByName('ID').AsInteger := FID;
end;

procedure TfrmPositionEdit.qryListBeforeOpen(DataSet: TDataSet);
begin
  inherited;
