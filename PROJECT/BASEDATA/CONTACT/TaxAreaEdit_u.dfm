inherited frmTaxAreaEdit: TfrmTaxAreaEdit
  ...
  object GDRES: TcxGrid [2]
    ...
    object TVRES: TcxGridDBTableView
      ...
      object TVRESTAXAREARES_ID: TcxGridDBColumn
        DataBinding.FieldName = 'TAXAREARES_ID'
        Visible = False
        VisibleForCustomization = False
        Width = 99
      end
      object TVRESTAXAREA_ID: TcxGridDBColumn
      ...
      object TVRESTAXAREA: TcxGridDBColumn
  ...
  object qryList: TFDQuery
    ...
    object qryListTAXAREA_ID: TFDAutoIncField
  ...
  object qryRes: TFDQuery
    MasterSource = dsList
    MasterFields = 'TAXAREA_ID'
    Connection = dmDatabase.FDConnection
    UpdateOptions.KeyFields = 'TAXAREARES_ID'
    SQL.Strings = (
      'SELECT '
      'TAXAREARES_ID,'
      'TAXAREA_ID,'
    ...
    object qryResTAXAREARES_ID: TIntegerField
      FieldName = 'TAXAREARES_ID'
      Origin = 'TAXAREARES_ID'
      Required = True
    end
    object qryResTAXAREA_ID: TIntegerField
      FieldName = 'TAXAREA_ID'
      Origin = 'TAXAREA_ID'
    end
    ...
    object qryResTAXAREA: TWideStringField
      FieldName = 'TAXAREA'
      Origin = 'TAXAREA'
      Size = 40
    end
  ...
  object qryCheckLangRes: TFDQuery
    ...
    SQL.Strings = (
      ...
      '  ('
      '   SELECT FIN_TAXAREARES.LANGUAGE_ID'
      '   FROM FIN_TAXAREARES'
      '   WHERE FIN_TAXAREARES.TAXAREA_ID = :ID'
      '  )'
      '  AND'
