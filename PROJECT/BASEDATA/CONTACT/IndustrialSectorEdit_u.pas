...
type
  TfrmIndustrialSectorEdit = class(T_frmBasisDialog)
    qryList: TFDQuery;
    dsList: TDataSource;
    GDRES: TcxGrid;
    ...
    qryResINDUSTRYSECTORSRES_ID: TFDAutoIncField;
    qryResINDUSTRYSECTORS_ID: TIntegerField;
    qryResLANGUAGE_ID: TIntegerField;
    qryResINDUSTRYSECTOR: TWideStringField;
    TVRESINDUSTRYSECTORSRES_ID: TcxGridDBColumn;
    TVRESINDUSTRYSECTORS_ID: TcxGridDBColumn;
    TVRESLANGUAGE_ID: TcxGridDBColumn;
    TVRESINDUSTRYSECTOR: TcxGridDBColumn;
...
var
  frmIndustrialSectorEdit: TfrmIndustrialSectorEdit;
...
constructor TfrmIndustrialSectorEdit.SetStart(AOwner: TComponent; ID: Integer; WinMode: TWinMode);
begin
...
procedure TfrmIndustrialSectorEdit.btnAddResClick(Sender: TObject);
begin
  inherited;
  FDS.Prepare;
  FDS.Params[0].AsString := 'CON_INDUSTRYSECTORSRES';
...
procedure TfrmIndustrialSectorEdit.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
  inherited;
...
procedure TfrmIndustrialSectorEdit.FormCreate(Sender: TObject);
...
procedure TfrmIndustrialSectorEdit.qryCheckLangResBeforeOpen(DataSet: TDataSet);
begin
  inherited;
  qryCheckLangRes.ParamByName('ID').AsInteger := FID;
end;

procedure TfrmIndustrialSectorEdit.qryListBeforeOpen(DataSet: TDataSet);
begin
  inherited;
