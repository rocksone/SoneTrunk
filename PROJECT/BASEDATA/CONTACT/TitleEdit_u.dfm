inherited frmTitleEdit: TfrmTitleEdit
  ...
  object GDRES: TcxGrid [2]
    ...
    object TVRES: TcxGridDBTableView
      ...
      object TVRESTITLE_ID: TcxGridDBColumn
        DataBinding.FieldName = 'TITLE_ID'
        Width = 69
      end
      object TVRESTITLERES_ID: TcxGridDBColumn
        DataBinding.FieldName = 'TITLERES_ID'
        Width = 88
      end
      ...
      object TVRESTITLE: TcxGridDBColumn
  ...
  object qryRes: TFDQuery
    MasterSource = dsList
    MasterFields = 'TITLE_ID'
    Connection = dmDatabase.FDConnection
    UpdateOptions.KeyFields = 'TITLERES_ID'
    SQL.Strings = (
      'SELECT '
      '   LANGUAGE_ID,'
      '   TITLE,'
    ...
    object qryResTITLE: TWideStringField
      FieldName = 'TITLE'
      Origin = 'TITLE'
      Size = 50
    end
    object qryResTITLERES_ID: TFDAutoIncField
      FieldName = 'TITLERES_ID'
      Origin = 'TITLERES_ID'
      ReadOnly = True
    end
    ...
    object qryResTITLE_ID: TIntegerField
      FieldName = 'TITLE_ID'
      Origin = 'TITLE_ID'
    end
  end
  ...
  object qryCheckLangRes: TFDQuery
    ...
    SQL.Strings = (
      ...
      '  ('
      '   SELECT CON_TITLERES.LANGUAGE_ID'
      '   FROM CON_TITLERES'
      '   WHERE CON_TITLERES.TITLE_ID = :ID'
      '  )'
      '  AND'
